...
module.exports = (server) => {
  ...
  socket.on('webrtc_answer', (event) => {
    console.log("Received webrtc_answer event:", event.callId);
...
socket.on('review_call_id', (data) => {
  console.log("review call id ==>>>>", data)
  socket.broadcast.emit('review_call_id', { id: data.id });
});
